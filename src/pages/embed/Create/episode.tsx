...
export default function CreateEpisode() {
  ...
  return (
    <div className="mt-4 mb-14">
      ...
      <section className="flex gap-x-8 mb-2 pb-8 mx-5">
        <div>
          <button
          ...
          >
            {!episodeInfo.image && (
              <span className="h-20 w-20 text-gray-500">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 flex gap-x-3">
            <div className="flex-1">
              ...
              <select
                value={episodeInfo.type}
                onChange={(e) => {
                  setInfo({ ...episodeInfo, type: e.target.value });
                }}
            ...
            <div className="flex-1">
              ...
              <select
                value={episodeInfo.clean_content}
                onChange={(e) => {
                  setInfo({
                    ...episodeInfo,
